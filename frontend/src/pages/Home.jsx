  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative z-30 -mt-16 sm:-mt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="bg-[var(--card-bg)] rounded-2xl shadow-xl border border-[var(--border-color)] backdrop-blur-xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[ 
              ...
              <div key={i} className="text-center group">
                ...
                <div className="text-sm sm:text-base text-[var(--text-muted)] font-medium">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-[var(--bg-main)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--text-main)] mb-4">{t('footer.services')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="group bg-[var(--card-bg)] p-8 rounded-2xl shadow-sm hover:shadow-xl border border-[var(--border-color)] transition-all duration-300 hover:-translate-y-2">
      ...
      <section className="py-24 bg-[var(--bg-main)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--text-main)] mb-4">Catégories</h2>
