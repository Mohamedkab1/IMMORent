      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 space-y-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-[var(--text-main)]">Notre histoire</h2>
            <div className="w-20 h-1.5 bg-secondary rounded-full"></div>
            <div className="prose dark:prose-invert prose-lg text-[var(--text-muted)]">
              <p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-[var(--border-color)]">
              <div className="text-center p-4 bg-[var(--card-bg)] rounded-2xl shadow-sm border border-[var(--border-color)]">
                <span className="block text-3xl font-black text-primary dark:text-secondary mb-1">500+</span>
                <span className="text-sm font-semibold text-[var(--text-muted)] uppercase tracking-wider">Biens</span>
              </div>
              <div className="text-center p-4 bg-[var(--card-bg)] rounded-2xl shadow-sm border border-[var(--border-color)]">
                <span className="block text-3xl font-black text-primary dark:text-secondary mb-1">10k+</span>
                <span className="text-sm font-semibold text-[var(--text-muted)] uppercase tracking-wider">Clients</span>
              </div>
              <div className="text-center p-4 bg-[var(--card-bg)] rounded-2xl shadow-sm border border-[var(--border-color)]">
                <span className="block text-3xl font-black text-primary dark:text-secondary mb-1">50+</span>
                <span className="text-sm font-semibold text-[var(--text-muted)] uppercase tracking-wider">Agences</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[var(--text-main)] inline-block relative mb-16">
            Nos valeurs
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-[var(--card-bg)] p-8 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-2 border border-[var(--border-color)] transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-[var(--text-main)] mb-3">{v.title}</h3>
                <p className="text-[var(--text-muted)] leading-relaxed font-medium">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-[var(--card-bg)] p-8 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-2 border border-[var(--border-color)] transition-all duration-300 group">
                <div className="relative w-32 h-32 mx-auto mb-6">
                  ...
                  <img 
                    src={member.img} 
                    alt={member.name} 
                    className="relative w-full h-full rounded-full object-cover border-4 border-[var(--card-bg)] shadow-lg" 
                  />
                </div>
                <h3 className="text-xl font-bold text-[var(--text-main)] mb-1">{member.name}</h3>
